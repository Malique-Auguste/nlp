...
fn main() {
    ...
    let shape = NetShape::new(vec![NetLayerType::DenseLayer { input_node_num: 9326, output_node_num: 933, act_func: ActFunc::Sigmoid },
                                                            NetLayerType::DenseLayer { input_node_num: 933, output_node_num: 1, act_func: ActFunc::Sigmoid }]).unwrap();
    ...
    */
    ...
    let tsettings = TSettings::new(100, 0.01, true, 30, Some("saved_nn/9/nn_min_train_err".into()), Some("saved_nn/9/nn_min_test_err".into())).unwrap();
